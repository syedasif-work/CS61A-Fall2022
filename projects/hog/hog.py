...
def play(strategy0, strategy1, update,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            num_of_dice_to_roll = strategy0(score0, score1)
            score0 = update(num_of_dice_to_roll, score0, score1, dice)
        else:
            num_of_dice_to_roll = strategy1(score1, score0)
            score1 = update(num_of_dice_to_roll, score1, score0, dice)
        who = 1 - who
    # END PROBLEM 5
...
def is_always_roll(strategy, goal=GOAL):
    ...
    i = 0
    j = 0
    prev_dice = strategy(0, 0)
    while i <= 99:
        while j <= 99:
            new_dice = strategy(i,j)
